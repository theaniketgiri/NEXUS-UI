...
export const Card = ({ header, footer, children, variant = 'default', style, headerStyle, footerStyle, ...props }) => {
    return (<View style={[styles.card, styles[variant], style]} {...props}>
      {header && (<View style={[styles.header, headerStyle]}>
          {typeof header === 'string' ? (<Text style={styles.headerText}>{header}</Text>) : (header)}
        </View>)}
      <View style={styles.content}>{children}</View>
      {footer && (<View style={[styles.footer, footerStyle]}>
